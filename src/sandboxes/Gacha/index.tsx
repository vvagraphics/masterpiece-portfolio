...
export default function Gacha(_props: GachaProps) {
  // 1. Shell States
  const [layoutMode, setLayoutMode] = useState<LayoutMode>('SPLIT_VERT'); // Defaulting to side-by-side for Gacha
  ...
  return (
    ...
    >
      <div className="w-full h-full bg-[#0a0a0a] relative flex items-center justify-center font-mono overflow-hidden">
