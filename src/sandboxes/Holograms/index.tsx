...
export default function Holograms(_props: HologramsProps) {
  ...
  return (
    <SandboxShell
      title="Hologram Sandbox"
      layoutMode={layoutMode}
      onLayoutChange={setLayoutMode}
      isEnvAudioMuted={isMuted}
      onToggleEnvAudio={() => setIsMuted(!isMuted)}
      controls={<SandboxControls schema={controlsSchema} onChange={handleControlChange} />}
    >
      <div className="w-full h-full bg-black relative flex items-center justify-center overflow-hidden font-mono">
        <div className="relative z-10 flex flex-col items-center justify-center perspective-[1000px]">
          ...
          <div className="relative">
            <h1 
              className="text-6xl font-black uppercase tracking-widest text-transparent mix-blend-screen text-center"
              style={{ 
            ...
            {settings.glitchIntensity > 0 && (
              <>
                <motion.h1 
                  ...
                  className="absolute inset-0 text-6xl font-black uppercase tracking-widest text-red-500 opacity-50 mix-blend-screen pointer-events-none text-center"
                >
                  {settings.hologramText}
                </motion.h1>
                <motion.h1 
                  ...
                  className="absolute inset-0 text-6xl font-black uppercase tracking-widest text-blue-500 opacity-50 mix-blend-screen pointer-events-none text-center"
                >
                  {settings.hologramText}
                </motion.h1>
              </>
