...
export default function StoryScroll({ onStoryComplete }: StoryScrollProps) {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-screen bg-black text-white overflow-hidden">
      ...
      {/* Chapter 1: MySpace */}
      <div ref={el => sectionsRef.current[0] = el} className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center opacity-0 bg-cover bg-center" style={{ backgroundImage: "url('https://mr3anderson.pro/masterpiece-portfolio/myspace.png')" }}>
      ...
      <div ref={el => sectionsRef.current[1] = el} className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center opacity-0 bg-cover bg-center" style={{ backgroundImage: "url('https://mr3anderson.pro/masterpiece-portfolio/first_web-background.jpg')" }}>
      ...
      {/* Chapter 3 */}
      <div ref={el => sectionsRef.current[2] = el} className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center opacity-0">
      ...
      {/* Chapter 4 */}
      <div ref={el => sectionsRef.current[3] = el} className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center opacity-0">
