...
export default function StoryScroll({ onStoryComplete, isAudioEnabled, toggleAudio }: StoryScrollProps) {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // ==========================================
        ...
        // FLYBY 1: Perfectly spaced to fill the 6.5s gap
        .fromTo('.era-1-flyby', 
          { xPercent: -50, yPercent: -50, x: "0vw", y: "0vh", scale: 0, opacity: 0, rotationZ: 0 }, 
          { x: (i, el) => `${el.dataset.x}vw`, y: (i, el) => `${el.dataset.y}vh`, scale: 1, opacity: 1, rotationZ: (i, el) => el.dataset.rotate, duration: 1.5, stagger: 0.9, ease: "power1.out" }, 
          'warp1+=0.5'
        )
        .to('.era-1-flyby', 
          { x: (i, el) => `${Number(el.dataset.x) * 3}vw`, y: (i, el) => `${Number(el.dataset.y) * 3}vh`, scale: 3, opacity: 0, duration: 1.0, stagger: 0.9, ease: "power2.in" }, 
          'warp1+=2.0'
        )
      ...
      // ==========================================
        .addLabel('warp2')
        .to(cameraRigRef.current, { z: 5000, ease: "power1.inOut", duration: 6.5 }, 'warp2')
      ...
      // ==========================================
        .addLabel('warp3')
        .to(cameraRigRef.current, { z: 10000, ease: "power1.inOut", duration: 6.5 }, 'warp3')
      ...
      // ==========================================
        .addLabel('warp4')
        .to(cameraRigRef.current, { z: 15000, ease: "power1.inOut", duration: 6.5 }, 'warp4')
      ...
      // ==========================================
        .addLabel('warp5')
        .to(cameraRigRef.current, { z: 20000, ease: "power1.inOut", duration: 6.5 }, 'warp5')
      ...
      // --- SCENE 5: AI FUTURE ---
        ...
        // Fade out agents AND the scene 5 text overlay simultaneously
        .addLabel('hideAgents')
  ...
  useEffect(() => {
    ...
    if (isAutoPlaying) {
      // Calculate remaining scroll duration so the speed stays consistent
      // even if the user pauses and resumes halfway down.
      const maxScroll = document.documentElement.scrollHeight - window.innerHeight;
      const currentScroll = window.scrollY;
      const remainingProgress = 1 - (currentScroll / maxScroll);
      
      // Total duration is 130s. If we are 50% down, remaining duration is 65s.
    ...
    >
      ...
      <div className="fixed top-4 right-4 md:top-8 md:right-8 z-[100] flex gap-2 md:gap-4">
        <button onClick={(e) => { e.stopPropagation(); setIsAutoPlaying(!isAutoPlaying); }}
          className="flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-full border border-white/20 transition-all bg-black/50 backdrop-blur-md hover:bg-white/10 hover:border-white/50"
      ...
      <div ref={cameraRigRef} className="absolute inset-0 w-full h-full"
        ...
        {/* ================= ERA 2 FLYBYS ================= */}
        <FlybyItem eraClass="era-2-flyby" z={-1000} xOffset={35} yOffset={-25} rotate={15} label="Polaroid Icon" imageUrl={`${imgBase}polaroid_icon.jpg`} />
        <FlybyItem eraClass="era-2-flyby" z={-2000} xOffset={-40} yOffset={20} rotate={-20} label="Glowing Bitcoin" imageUrl={`${imgBase}glowing_bitcoin.jpg`}/>
        <FlybyItem eraClass="era-2-flyby" z={-3000} xOffset={40} yOffset={25} rotate={5} label="Diamond Pickaxe" imageUrl={`${imgBase}minecraft_pickaxe.jpg`}/>
        <FlybyItem eraClass="era-2-flyby" z={-4000} xOffset={-30} yOffset={-20} rotate={-10} label="Pokéball" imageUrl={`${imgBase}pokeball.jpg`}/>
        ...
        {/* ================= ERA 3 FLYBYS ================= */}
        <FlybyItem eraClass="era-3-flyby" z={-6000} xOffset={-35} yOffset={30} rotate={-15} label="Figma Pen" imageUrl={`${imgBase}figma_pen_tool.jpg`}/>
        <FlybyItem eraClass="era-3-flyby" z={-7000} xOffset={30} yOffset={-25} rotate={10} label="OG AirPods" imageUrl={`${imgBase}original_airpods.jpg`}/>
        <FlybyItem eraClass="era-3-flyby" z={-8000} xOffset={-40} yOffset={-20} rotate={-5} label="Glitch Logo" imageUrl={`${imgBase}tiktok_glitch_logo.jpg`}/>
        <FlybyItem eraClass="era-3-flyby" z={-9000} xOffset={35} yOffset={20} rotate={25} label="Llama Piñata" imageUrl={`${imgBase}fortnite_llama.jpg`}/>
        ...
        {/* ================= ERA 4 FLYBYS ================= */}
        <FlybyItem eraClass="era-4-flyby" z={-11000} xOffset={30} yOffset={-30} rotate={5} label="Zoom Webcams" imageUrl={`${imgBase}zoom_webcams_grid.jpg`}/>
        <FlybyItem eraClass="era-4-flyby" z={-12000} xOffset={-35} yOffset={25} rotate={-10} label="Masks & Space" imageUrl={`${imgBase}masks_distancing.jpg`}/>
        <FlybyItem eraClass="era-4-flyby" z={-13000} xOffset={40} yOffset={30} rotate={15} label="Bored Ape NFT" imageUrl={`${imgBase}bored_ape_nft.jpg`}/>
        <FlybyItem eraClass="era-4-flyby" z={-14000} xOffset={-30} yOffset={-35} rotate={-20} label="James Webb" imageUrl={`${imgBase}james_webb_mirror.jpg`}/>
        ...
        {/* ================= ERA 5 FLYBYS ================= */}
        <FlybyItem eraClass="era-5-flyby" z={-16000} xOffset={-40} yOffset={-10} rotate={-5} label="AR/VR Headset" imageUrl={`${imgBase}ar_vr_headset.jpg`}/>
        <FlybyItem eraClass="era-5-flyby" z={-17000} xOffset={35} yOffset={-25} rotate={10} label="Neural Mesh" imageUrl={`${imgBase}neural_network_mesh.jpg`}/>
        <FlybyItem eraClass="era-5-flyby" z={-18000} xOffset={-30} yOffset={35} rotate={-15} label="Robotic Hand" imageUrl={`${imgBase}robotic_hand.jpg`}/>
        <FlybyItem eraClass="era-5-flyby" z={-19000} xOffset={40} yOffset={25} rotate={20} label="Hologram UI" imageUrl={`${imgBase}holographic_ui_panels.jpg`}/>
